...
export default function CoachMsgCard({
    coachId,
    latestRecord,
    stats,
    ...
    return (
        <div
            className={`bg-gradient-to-br ${coach.bgGradient} rounded-2xl p-5 border-2 ${coach.borderColor} shadow-lg`}
        >
            {/* Header */}
            <div className="flex items-center gap-3 mb-4">
                <div
                    className={`w-12 h-12 rounded-full bg-gradient-to-br ${coach.color} flex items-center justify-center shadow-md`}
                >
